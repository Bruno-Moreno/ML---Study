...
\end{figure}
El valor óptimo es el último punto después del cual todos los lags están dentro de las bandas azules (intervalos de confianza), en este caso, este punto no es claro pues la serie presenta \textit{seasonality} pero $p=11$ muestra una autocorrelación importante. 
...
\end{figure}
En este caso, el valor $q=12$ muestra una una autocorrelación notable.
