...
El modelo ARIMA hace referencia al \textit{Auto-Regressive Integrated Moving Average} y es un método estadístico para realizar \textit{forecasting} sobre series de tiempo que integra los siguientes conceptos:
...
En la práctica, es posible determinar estos valores 
